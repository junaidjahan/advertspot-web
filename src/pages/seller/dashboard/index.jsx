    ...
    return (
        <div>
            <Container maxWidth='md'>
                ...
                <Box sx={{marginY:2}}>
                    <Accordion elevation="0" sx={{ borderRadius: 4, borderColor: 'rgba(0, 0, 0, 0.12)',borderStyle:'solid',borderWidth:'1px' }} square expanded={IsAOExpanded} onChange={() => setIsAOExpanded(!IsAOExpanded)}>
                                <AccordionSummary
                ...
                <Box sx={{ marginY: 2 }}>
                    <Accordion elevation="0" sx={{ borderRadius: 4, borderColor: 'rgba(0, 0, 0, 0.12)', borderStyle: 'solid', borderWidth: '1px' }} square expanded={IsCOExpanded} onChange={() => setIsCOExpanded(!IsCOExpanded)}>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                            aria-controls="panel4bh-content"
                            id="panel4bh-header"
                ...
                <Box sx={{ marginY: 2 }}>
                    <Accordion elevation="0" sx={{ borderRadius: 4, borderColor: 'rgba(0, 0, 0, 0.12)', borderStyle: 'solid', borderWidth: '1px' }} square expanded={IsCAExpanded} onChange={() => setIsCAExpanded(!IsCAExpanded)}>
                        <AccordionSummary
                            expandIcon={<ExpandMoreIcon />}
                            aria-controls="panel4bh-content"
                            id="panel4bh-header"
